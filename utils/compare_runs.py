# Baesd on https://github.com/hamelsmu/wandb-cicd/blob/main/client/compare_runs.py
# This script is used to compare the current run to the baseline run.
...
def get_baseline_run(entity='sertingolix', project='DAP-2', tag='baseline'):
...
def compare_runs(entity='sertingolix',
                 project='DAP-2',
                 tag='baseline',
                 run_id=None):
